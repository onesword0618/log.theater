...
type SiteMetaDataQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly locale: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly email: string | null, readonly siteIcon: string | null, readonly author: { readonly name: string | null, readonly excerpt: string | null } | null, readonly social: { readonly twitter: string | null, readonly github: string | null } | null } | null } | null };
