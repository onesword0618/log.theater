  ...
  return (
    <Layout metaData={useSiteMetaData()}>
      <article className="introduce">
        ...
        <p>
          その一員として生活や仕事その他で大きな恩恵を受けていることを実感しています。
        </p>

        <p>
          そして、私自身もその一員として自分の能力や経験、考えを用いて貢献していこうと思っています。
        </p>
        ...
        <p>
          なので、他人と力を合わせて任務に取り組むためには、自分がまず約束を果たさないと他人に約束を守ってもらうことができないと思って行動しています。
        </p>
