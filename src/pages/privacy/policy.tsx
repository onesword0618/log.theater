...
import { container, list, noneList } from './policy.module.css';
      ...
      <article className={container}>
        ...
        <p>
          ...
          <ul className={noneList}>
            <li>(1) ユーザーのトラフィック測定及び行動測定のため</li>
            <li>(2) 広告の配信、表示及び効果測定のため</li>
        ...
        <p>
          <ul className={noneList}>
            ...
            <li>
              8-2
              当人は、ユーザーから、ユーザーの個人情報について消去を求められた場合、当人が当該請求に応じる必要があると判断した場合は、ユーザーご本人からのご請求であることを確認の上で、個人情報の消去を行い、その旨をユーザーに通知します。
            </li>
            <li>
              8-3
              個人情報保護法その他の法令により、当人が訂正等または利用停止等の義務を負わない場合は、8-1および8-2の規定は適用されません。
            </li>
          </ul>
        </p>
